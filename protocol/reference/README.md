...
> 全量 404 个命令，按业务域分文件。字段名为 snake_case 规范命名，附中文说明。

> 如何组装请求、判断成功失败见 [API.md](../API.md)；帧格式与加密见 [NOTES.md](NOTES.md)。

| 文件 | 业务域 | 命令数 | cmd 范围 |
|---|---|---|---|
| [00-choice.md](00-choice.md) | 选服与渠道登录（Choice 通道） | 14 | 1 ~ 30 |
| [01-account.md](01-account.md) | 账号与玩家 | 34 | 1001 ~ 1050 |
| [02-city.md](02-city.md) | 城池与资源 | 27 | 2001 ~ 2030 |
| [03-army.md](03-army.md) | 军队与训练 | 14 | 3001 ~ 3015 |
| [04-tech.md](04-tech.md) | 科技研发 | 6 | 4001 ~ 4008 |
| [05-alliance.md](05-alliance.md) | 军团 | 50 | 5001 ~ 5062 |
| [06-chat.md](06-chat.md) | 聊天 | 16 | 6001 ~ 6016 |
| [07-item.md](07-item.md) | 道具与背包 | 9 | 8001 ~ 8023 |
...
| [13-activity.md](13-activity.md) | 活动 | 30 | 22001 ~ 23004 |
...
| [17-push.md](17-push.md) | 服务端推送（Broadcast） | 23 | 26001 ~ 26027 |

> 共 404 个命令（另有继承空壳类不计入）。
