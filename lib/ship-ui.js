...
function HeaderBar({ connected, dry, hubs, army, floorHours, fuelHours }) {
  return html`
    <${Box} flexDirection="column">
      ...
      ${(army || floorHours || fuelHours)
        ? html`<${Text} dimColor>兵种: ${army || '—'} · 底仓线 ${floorHours ?? 24}h · 油耗保留 ${fuelHours ?? 6}h<//>`
        : null}
